 ...
 */
  ...
  vector<shared_ptr<Process> > sample_tt2l_Comb = {tt2l_Comb};
  vector<shared_ptr<Process> > sample_tt1l_Comb = {tt1l_Comb};
  ...
  vector<PlotMaker *> pms = {pm2016,pm2017,pm2018,pmComb,pmComb,pmComb};
  vector<vector<shared_ptr<Process> > > samples_Run2 = {sample_list_2016,sample_list_2017,sample_list_2018,sample_list_Comb,sample_tt2l_Comb,sample_tt1l_Comb};
  vector<string> years = {"y2016","y2017","y2018","yAll","yAll_tt2l","yAll_tt1l"};
  ...
  for(uint isel=0;isel<sels.size();isel++){
    for(uint iyear=0;iyear<samples_Run2.size();iyear++){
      for(uint iweight=0;iweight<weights.size();iweight++){
          ...
          pms[iyear]->Push<Hist1D>(Axis(10, 100., 300., "pfmet", "E_{T}^{miss} [GeV]"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);
          
          pms[iyear]->Push<Hist1D>(Axis(10, 100., 300., "pfmet_jup", "pfmet_jup"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(10, 100., 300., "pfmet_jdown", "pfmet_jdown"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(10, 100., 300., "mt_met_lep", "mt [GeV]"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(10, 100., 300., "mt_met_lep_jup", "mt_met_lep_jup"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(10, 100., 300., "mt_met_lep_jdown", "mt_met_lep_jdown"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(15, 50., 200., "mbb", "mbb [GeV]"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);
          
          pms[iyear]->Push<Hist1D>(Axis(15, 50., 200., "jup_mbb", "jup_mbb"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(15, 50., 200., "jdown_mbb", "jdown_mbb"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(10, 100., 300., "mct", "mct [GeV]"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(10, 100., 300., "jup_mct", "jup_mct"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(10, 100., 300., "jdown_mct", "jdown_mct"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);


          pms[iyear]->Push<Hist1D>(Axis(15, 50., 200., "jerup_mbb", "jerup_mbb"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(15, 50., 200., "jerdown_mbb", "jerdown_mbb"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(10, 100., 300., "jerup_mct", "jerup_mct"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(10, 100., 300., "jerdown_mct", "jerdown_mct"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);


          pms[iyear]->Push<Hist1D>(Axis(100, -50., 50., pfmet_subt_jup, "pfmet-pfmet_JESup"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(100, -50., 50., pfmet_subt_jdown, "pfmet-pfmet_JESdown"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(100, -50., 50., mt_subt_jup, "mt-mt_JESup"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(100, -50., 50., mt_subt_jdown, "mt-mt_JESdown"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(20, -10., 10., mct_subt_jup, "mct-mct_JESup"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(20, -10., 10., mct_subt_jdown, "mct-mct_JESdown"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(20, -10., 10., mbb_subt_jup, "mbb-mbb_JESup"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(20, -10., 10., mbb_subt_jdown, "mbb-mbb_JESdown"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(20, -10., 10., mct_subt_jerup, "mct-mct_JERup"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(20, -10., 10., mct_subt_jerdown, "mct-mct_JERdown"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(20, -10., 10., mbb_subt_jerup, "mbb-mbb_JERup"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);

          pms[iyear]->Push<Hist1D>(Axis(20, -10., 10., mbb_subt_jerdown, "mbb-mbb_JERdown"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("JetResStudy_"+years[iyear]+sels_tags[isel]);
