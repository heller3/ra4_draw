...
int main(){
  ...
  auto diboson_2017 = Process::MakeShared<Baby_full>("Diboson 2017", Process::Type::background, colors("other"),{mc2017_dir+"*WW*.root", mc2017_dir+"slim*WZ*.root",mc2017_dir+"*ZZ*.root"});
  ...
  auto diboson_Comb = Process::MakeShared<Baby_full>("Diboson 2016-2018", Process::Type::background, colors("other"),{mc2016_dir+"*WW*.root", mc2016_dir+"*WZ*.root",mc2016_dir+"*ZZ*.root",mc2017_dir+"*WW*.root", mc2017_dir+"slim*WZ*.root",mc2017_dir+"*ZZ*.root",mc2018_dir+"slim*WW*.root", mc2018_dir+"slim*WZ*.root",mc2018_dir+"slim*ZZ*.root"});
  ...
  auto lostlepbkg_Comb_lowMT_CR = Process::MakeShared<Baby_full>("t#bar{t} (2l) + Single t (low mT CR) 2016-2018", Process::Type::background, colors("tt_2l"),{mc2016_dir+"*TTJets_2lep_*.root",mc2017_dir+"*TTJets_2lep_*.root",mc2018_dir+"slim*TTJets_2lep_*.root",mc2016_dir+"*_ST_*.root",mc2017_dir+"*_ST_*.root",mc2018_dir+"slim*_ST_*.root"},WHLeptons>=1&&"pass&&nvetoleps==2&&ngoodjets==2&&pfmet>125&&mt_met_lep>100&&ngoodbtags==2&&stitch");
  auto lostlepbkg_Comb_regMT_CR = Process::MakeShared<Baby_full>("t#bar{t} (2l) + Single t (high mT CR) 2016-2018", Process::Type::background, colors("tt_1l"),{mc2016_dir+"*TTJets_2lep_*.root",mc2017_dir+"*TTJets_2lep_*.root",mc2018_dir+"slim*TTJets_2lep_*.root",mc2016_dir+"*_ST_*.root",mc2017_dir+"*_ST_*.root",mc2018_dir+"slim*_ST_*.root"},WHLeptons>=1&&"pass&&nvetoleps==2&&ngoodjets==2&&pfmet>125&&mt_met_lep>150&&ngoodbtags==2&&stitch");
  auto lostlepbkg_Comb_SR = Process::MakeShared<Baby_full>("t#bar{t} (2l) + Single t (SR) 2016-2018", Process::Type::background, colors("wjets"),{mc2016_dir+"*TTJets_2lep_*.root",mc2017_dir+"*TTJets_2lep_*.root",mc2018_dir+"slim*TTJets_2lep_*.root",mc2016_dir+"*_ST_*.root",mc2017_dir+"*_ST_*.root",mc2018_dir+"slim*_ST_*.root"},"pass&&nvetoleps==1&&ngoodjets==2&&pfmet>125&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1&&"stitch");

  auto lostlepbkg_3j_Comb_lowMT_CR = Process::MakeShared<Baby_full>("t#bar{t} (2l) + Single t (low mT, 3j CR) 2016-2018", Process::Type::background, colors("tt_2l"),{mc2016_dir+"*TTJets_2lep_*.root",mc2017_dir+"*TTJets_2lep_*.root",mc2018_dir+"slim*TTJets_2lep_*.root",mc2016_dir+"*_ST_*.root",mc2017_dir+"*_ST_*.root",mc2018_dir+"slim*_ST_*.root"},WHLeptons>=1&&LeadingNonBJetPt_med<100&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>125&&mt_met_lep>100&&ngoodbtags==2&&stitch");
  auto lostlepbkg_3j_Comb_regMT_CR = Process::MakeShared<Baby_full>("t#bar{t} (2l) + Single t (high mT, 3j CR) 2016-2018", Process::Type::background, colors("tt_1l"),{mc2016_dir+"*TTJets_2lep_*.root",mc2017_dir+"*TTJets_2lep_*.root",mc2018_dir+"slim*TTJets_2lep_*.root",mc2016_dir+"*_ST_*.root",mc2017_dir+"*_ST_*.root",mc2018_dir+"slim*_ST_*.root"},WHLeptons>=1&&LeadingNonBJetPt_med<100&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>125&&mt_met_lep>150&&ngoodbtags==2&&stitch");
  auto lostlepbkg_3j_Comb_SR = Process::MakeShared<Baby_full>("t#bar{t} (2l) + Single t (3j SR) 2016-2018", Process::Type::background, colors("wjets"),{mc2016_dir+"*TTJets_2lep_*.root",mc2017_dir+"*TTJets_2lep_*.root",mc2018_dir+"slim*TTJets_2lep_*.root",mc2016_dir+"*_ST_*.root",mc2017_dir+"*_ST_*.root",mc2018_dir+"slim*_ST_*.root"},"pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mt_met_lep>150&&ngoodbtags==2" && LeadingNonBJetPt_med<100&& WHLeptons==1&&"stitch");
  ...
  NamedFunc dilepton_looseLep_lowMT_extMBB       = WHLeptons>=1&&"pass&&nvetoleps==2&&ngoodjets==2&&pfmet>125&&mbb>90&&mbb<200&&mct>200&&mt_met_lep>100&&ngoodbtags==2";
  NamedFunc dilepton_looseLep_lowMT_extMBB_noMCT = WHLeptons>=1&&"pass&&nvetoleps==2&&ngoodjets==2&&pfmet>125&&mbb>90&&mbb<200&&mt_met_lep>100&&ngoodbtags==2";

  NamedFunc dilepton_looseLep_3jet_lowMT_extMBB       = WHLeptons>=1&&LeadingNonBJetPt_med<100&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>125&&mbb>200&&mbb<150&&mct>200&&mt_met_lep>100&&ngoodbtags==2";
  NamedFunc dilepton_looseLep_3jet_lowMT_extMBB_noMCT = WHLeptons>=1&&LeadingNonBJetPt_med<100&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>125&&mbb>200&&mbb<150&&mt_met_lep>100&&ngoodbtags==2";
  ...
  NamedFunc dilepton_looseLep_loose3jet_extMBB       = WHLeptons>=1&&LeadingNonBJetPt_med<200&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>125&&mbb>90&&mbb<200&&mct>200&&mt_met_lep>150&&ngoodbtags==2";
  NamedFunc dilepton_looseLep_loose3jet_extMBB_noMCT = WHLeptons>=1&&LeadingNonBJetPt_med<200&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>125&&mbb>90&&mbb<200&&mt_met_lep>150&&ngoodbtags==2";
  NamedFunc dilepton_looseLep_loose3jet_extMBB_noMT  = WHLeptons>=1&&LeadingNonBJetPt_med<200&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>125&&mbb>90&&mbb<200&&mct>200&&ngoodbtags==2";
  NamedFunc dilepton_looseLep_loose3jet_extMBB_noMBB = WHLeptons>=1&&LeadingNonBJetPt_med<200&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>125&&mct>200&&ngoodbtags==2";
  ...
  vector<NamedFunc> sels   = {/*dilepton_looseLep_lowMET,
                              ...
                              dilepton_looseLep_lowMT_extMBB,
                              dilepton_looseLep_lowMT_extMBB_noMCT,
                              dilepton_looseLep_3jet_lowMT_extMBB,
                              dilepton_looseLep_3jet_lowMT_extMBB_noMCT,
                              ...
                              dilepton_looseLep_loose3jet_extMBB,
                              dilepton_looseLep_loose3jet_extMBB_noMCT,
                              dilepton_looseLep_loose3jet_extMBB_noMT,
                              dilepton_looseLep_loose3jet_extMBB_noMBB,
  ...
  vector<string> sels_tags = {/*"_dilepton_looseLep_lowMET",
                              ...
                              "_dilepton_looseLep_lowMT_extMBB",
                              "_dilepton_looseLep_lowMT_extMBB_noMCT",
                              "_dilepton_looseLep_3jet_lowMT_extMBB",
                              "_dilepton_looseLep_3jet_lowMT_extMBB_noMCT",
                              ...
                              "_dilepton_looseLep_loose3jet_extMBB",
                              "_dilepton_looseLep_loose3jet_extMBB_noMCT",
                              "_dilepton_looseLep_loose3jet_extMBB_noMT",
                              "_dilepton_looseLep_loose3jet_extMBB_noMBB",
  ...
  PlotMaker * pmSRComb = new PlotMaker();
   ...
   //Selections
  NamedFunc signalRegion       = "pass&&nvetoleps==1&&ngoodjets==2&&pfmet>125&&mbb>90&&mbb<150&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1;
  NamedFunc signalRegion_noMBB = "pass&&nvetoleps==1&&ngoodjets==2&&pfmet>125&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1;
  NamedFunc signalRegion_noMCT = "pass&&nvetoleps==1&&ngoodjets==2&&pfmet>125&&mbb>90&&mbb<150&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1;
  NamedFunc signalRegion_noMT  = "pass&&nvetoleps==1&&ngoodjets==2&&pfmet>125&&mbb>90&&mbb<150&&mct>200&&ngoodbtags==2" && WHLeptons==1;

  NamedFunc signalRegion_3jet       = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mbb>90&&mbb<150&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1 && LeadingNonBJetPt_med<100;
  NamedFunc signalRegion_3jet_noMBB = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1 && LeadingNonBJetPt_med<100;
  NamedFunc signalRegion_3jet_noMCT = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mbb>90&&mbb<150&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1 && LeadingNonBJetPt_med<100;
  NamedFunc signalRegion_3jet_noMT  = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mbb>90&&mbb<150&&mct>200&&ngoodbtags==2" && WHLeptons==1 && LeadingNonBJetPt_med<100;

  NamedFunc signalRegion_loose3jet       = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mbb>90&&mbb<150&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1 && LeadingNonBJetPt_med<200;
  NamedFunc signalRegion_loose3jet_noMBB = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1 && LeadingNonBJetPt_med<200;
  NamedFunc signalRegion_loose3jet_noMCT = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mbb>90&&mbb<150&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1 && LeadingNonBJetPt_med<200;
  NamedFunc signalRegion_loose3jet_noMT  = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mbb>90&&mbb<150&&mct>200&&ngoodbtags==2" && WHLeptons==1 && LeadingNonBJetPt_med<200;

  NamedFunc signalRegion_no3jet       = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mbb>90&&mbb<150&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1;
  NamedFunc signalRegion_no3jet_noMBB = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1;
  NamedFunc signalRegion_no3jet_noMCT = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mbb>90&&mbb<150&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1;
  NamedFunc signalRegion_no3jet_noMT  = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&mbb>90&&mbb<150&&mct>200&&ngoodbtags==2" && WHLeptons==1;

  NamedFunc signalRegion_nojet        = "pass&&nvetoleps==1&&ngoodbtags==2&&pfmet>125&&mbb>90&&mbb<150&&mct>200&&mt_met_lep>150" && WHLeptons==1;

  NamedFunc signalRegion_no3jet_highMET       = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>200&&mbb>90&&mbb<150&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1;
  NamedFunc signalRegion_no3jet_highMET_res       = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>200&&mbb>90&&mbb<150&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1&&max_ak8pfjets_deepdisc_hbb<=0.8;
  NamedFunc signalRegion_no3jet_highMET_boost       = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>200&&mbb>90&&mbb<150&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1&&max_ak8pfjets_deepdisc_hbb>0.8;

  NamedFunc signalRegion_no3jet_windMET       = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&pfmet<200&&mbb>90&&mbb<150&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1;
  NamedFunc signalRegion_no3jet_windMET_res       = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&pfmet<200&&mbb>90&&mbb<150&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1&&max_ak8pfjets_deepdisc_hbb<=0.8;
  NamedFunc signalRegion_no3jet_windMET_boost       = "pass&&nvetoleps==1&&ngoodjets==3&&pfmet>125&&pfmet<200&&mbb>90&&mbb<150&&mct>200&&mt_met_lep>150&&ngoodbtags==2" && WHLeptons==1&&max_ak8pfjets_deepdisc_hbb>0.8;
