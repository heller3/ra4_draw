...
//  string ZZ2018_dir = "/home/users/dspitzba/wh_babies/babies_v33_4_2020_06_02/a18v1/";
  ...
  std::string basic_cut = "pfmet>125&&mct>200&&mbb>90&&mbb<150&&ngoodbtags==2&&nvetoleps==1&&pass&&PassTrackVeto&&PassTauVeto&&hasNano>0";//&&ngoodjets==2";
  //  std::string basic_cut3 = "pfmet>125&&mct>200&&nvetoleps==1&&pass&&PassTrackVeto&&PassTauVeto&&nHiggs==1&&hasNano>0&&ngoodjets==3";
...
//  auto dataComb = Process::MakeShared<Baby_full>("Combined Data", Process::Type::data, colors("data"),{data2016_dir+"slim_data_2016*.root",data2017_dir+"slim_data_2017*.root",data2018_dir+"slim_data_2018*.root"},"pass&&(HLT_SingleEl==1||HLT_SingleMu==1||HLT_MET_MHT==1)"&&HasHEMevent==0.&&HasHEMjet==0.);
  ...
  // all ttbar
  auto tt_2016_all = Process::MakeShared<Baby_full>("t#tbar{t} (1,2l) 2016", Process::Type::background, colors("other"),{mc2016_dir+"slim*TTJets*root"}, "stitch");
  auto tt_2017_all = Process::MakeShared<Baby_full>("t#tbar{t} (1,2l) 2017", Process::Type::background, colors("other"),{mc2017_dir+"slim*TTJets*root"}, "stitch");
  auto tt_2018_all = Process::MakeShared<Baby_full>("t#tbar{t} (1,2l) 2018", Process::Type::background, colors("other"),{mc2018_dir+"slim*TTJets*root"}, "stitch");
  auto tt_comb_all = Process::MakeShared<Baby_full>("t#tbar{t} (1,2l) Combined", Process::Type::background, colors("other"),{mc2016_dir+"slim*TTJets*root",mc2017_dir+"slim*TTJets*root",mc2018_dir+"slim*TTJets*root"}, "stitch");
...
//  auto tt2l_Comb_met = Process::MakeShared<Baby_full>("t#bar{t} (2l) Combined met", Process::Type::background, colors("tt_2l"),{mc2016_dir+"slim*TTJets_2lep_*met*.root",mc2017_dir+"slim*TTJets_2lep_*met*.root",mc2018_dir+"slim*TTJets_2lep_*met*.root"});//,"stitch");
  ...
  vector<shared_ptr<Process> > sample_list_2016 = {SM_WH_2016,tt_2016_all,/*tt2l_2016,tt1l_2016,tt2l_2016_met,tt1l_2016_met,*/single_t_2016,wjets_2016,ttV_2016,diboson_2016,signal_2016_225_75,signal_2016_700_1,signal_2016_650_300};
  vector<shared_ptr<Process> > sample_list_2017 = {SM_WH_2017,tt_2017_all,/*tt2l_2017,tt1l_2017,tt2l_2017_met,tt1l_2017_met,*/single_t_2017,wjets_2017,ttV_2017,diboson_2017,signal_2017_225_75,signal_2017_700_1,signal_2017_650_300};
  vector<shared_ptr<Process> > sample_list_2018 = {SM_WH_2018,tt_2018_all,/*tt2l_2018,tt1l_2018,tt2l_2018_met,tt1l_2018_met,*/single_t_2018,wjets_2018,ttV_2018,diboson_2018,signal_2018_225_75,signal_2018_700_1,signal_2018_650_300};
  //  vector<shared_ptr<Process> > sample_list_2017 = {diboson_2017};
  // Column combinations all years
  vector<shared_ptr<Process> > sample_list_comb = {SM_WH_Comb, tt_comb_all, /*tt2l_Comb, tt1l_Comb, tt2l_Comb_met, tt1l_Comb_met,*/ single_t_Comb, wjets_Comb, ttV_Comb, diboson_Comb, signal_comb_225_75, signal_comb_700_1, signal_comb_650_300};
...
//  vector<PlotOpt> bkg_pts = {style2D().Stack(StackType::lumi_shapes).Title(TitleType::info)};
  ...
  Table & cutflow_SR_2016 = pm.Push<Table>("cutflow_SR_2016", vector<TableRow>{
      TableRow("2 good jets, 1 Higgs, mt$>$150"     , nFatJet250>=1&&WHLeptons==1&&basic_cut&&"ngoodjets==2&&nHiggs==1&&mt_met_lep>150", 0, 0, "w_noBtagSF"*yearWeight),
      TableRow("2 good jets, 0 Higgs, mt$>$150"     , nFatJet250>=1&&WHLeptons==1&&basic_cut&&"ngoodjets==2&&nHiggs==0&&mt_met_lep>150", 0, 0, "w_noBtagSF"*yearWeight),
      TableRow("2 good jets, 1 Higgs, 50$<$mt$<$150", nFatJet250>=1&&WHLeptons==1&&basic_cut&&"ngoodjets==2&&nHiggs==1&&mt_met_lep>50&&mt_met_lep<150", 0, 0, "w_noBtagSF"*yearWeight),
      TableRow("2 good jets, 0 Higgs, 50$<$mt$<$150", nFatJet250>=1&&WHLeptons==1&&basic_cut&&"ngoodjets==2&&nHiggs==0&&mt_met_lep>50&&mt_met_lep<150", 0, 0, "w_noBtagSF"*yearWeight),
      TableRow("3 good jets, 1 Higgs, mt$>$150"     , nFatJet250>=1&&WHLeptons==1&&basic_cut&&"ngoodjets==3&&nHiggs==1&&mt_met_lep>150", 0, 0, "w_noBtagSF"*yearWeight),
      TableRow("3 good jets, 0 Higgs, mt$>$150"     , nFatJet250>=1&&WHLeptons==1&&basic_cut&&"ngoodjets==3&&nHiggs==0&&mt_met_lep>150", 0, 0, "w_noBtagSF"*yearWeight),
      TableRow("3 good jets, 1 Higgs, 50$<$mt$<$150", nFatJet250>=1&&WHLeptons==1&&basic_cut&&"ngoodjets==3&&nHiggs==1&&mt_met_lep>50&&mt_met_lep<150", 0, 0, "w_noBtagSF"*yearWeight),
      TableRow("3 good jets, 0 Higgs, 50$<$mt$<$150", nFatJet250>=1&&WHLeptons==1&&basic_cut&&"ngoodjets==3&&nHiggs==0&&mt_met_lep>50&&mt_met_lep<150", 0, 0, "w_noBtagSF"*yearWeight),
...
//  // 1. 2 good jets, mT > 150
//  Table & cutflow_SR_2jet_mT150_2016 = pm.Push<Table>("cutflow_SR_2jet_mT150_2016", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut2, 0, 0, "w_noBtagSF"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut2&&"pfmet>125", 0, 0, "w_noBtagSF"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200", 0, 0, "w_noBtagSF"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>150", 0, 0, "w_noBtagSF"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep, 90$<$mbb$<$150", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150", 0, 0, "w_noBtagSF"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep, 90$<$mbb$<$150, 2 good b tags", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2", 0, 0, "w_noBtagSF"*yearWeight), 
//	}, sample_list_2016, false);
//  Table & cutflow_SR_2jet_mT150_2017 = pm.Push<Table>("cutflow_SR_2jet_mT150_2017", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut2, 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut2&&"pfmet>125", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>150", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep, 90$<$mbb$<$150", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep, 90$<$mbb$<$150, 2 good b tags", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2", 0, 0, "weight"*yearWeight), 
//	}, sample_list_2017, false);
//  Table & cutflow_SR_2jet_mT150_2018 = pm.Push<Table>("cutflow_SR_2jet_mT150_2018", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut2, 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut2&&"pfmet>125", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>150", 0, 0, "weight"*yearWeight),
...
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep, 90$<$mbb$<$150, 2 good b tags", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2", 0, 0, "weight"*yearWeight), 
//	}, sample_list_2018, false);
//  Table & cutflow_SR_2jet_mT150_all = pm.Push<Table>("cutflow_SR_2jet_mT150_all", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut2, 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut2&&"pfmet>125", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>150", 0, 0, "weight"*yearWeight),
...
//	}, sample_list_comb, false);
//
//  // 2. 2 good jets, 150 > mT > 50
//  Table & cutflow_SR_2jet_50mT150_2016 = pm.Push<Table>("cutflow_SR_2jet_50mT150_2016", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut2, 0, 0, "w_noBtagSF"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut2&&"pfmet>125", 0, 0, "w_noBtagSF"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200", 0, 0, "w_noBtagSF"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150", 0, 0, "w_noBtagSF"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150, 90$<$mbb$<$150", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150&&mbb>90&&mbb<150", 0, 0, "w_noBtagSF"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150, 90$<$mbb$<$150, 2 good b tags", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150&&mbb>90&&mbb<150&&ngoodbtags==2", 0, 0, "w_noBtagSF"*yearWeight), 
//	}, sample_list_2016, false);
//  Table & cutflow_SR_2jet_50mT150_2017 = pm.Push<Table>("cutflow_SR_2jet_50mT150_2017", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut2, 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut2&&"pfmet>125", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150, 90$<$mbb$<$150", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150&&mbb>90&&mbb<150", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150, 90$<$mbb$<$150, 2 good b tags", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150&&mbb>90&&mbb<150&&ngoodbtags==2", 0, 0, "weight"*yearWeight), 
//	}, sample_list_2017, false);
//  Table & cutflow_SR_2jet_50mT150_2018 = pm.Push<Table>("cutflow_SR_2jet_50mT150_2018", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut2, 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut2&&"pfmet>125", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150", 0, 0, "weight"*yearWeight),
...
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150, 90$<$mbb$<$150, 2 good b tags", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150&&mbb>90&&mbb<150&&ngoodbtags==2", 0, 0, "weight"*yearWeight), 
//	}, sample_list_2018, false);
//  Table & cutflow_SR_2jet_50mT150_all = pm.Push<Table>("cutflow_SR_2jet_50mT150_all", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut2, 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut2&&"pfmet>125", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150", WHLeptons==1&&basic_cut2&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150", 0, 0, "weight"*yearWeight),
...
//	}, sample_list_comb, false);
//
//  // 3. 3 good jets, mT > 150
//  Table & cutflow_SR_3jet_mT1502016 = pm.Push<Table>("cutflow_SR_3jet_mT1502016", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut3, 0, 0, "w_noBtagSF"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut3&&"pfmet>125", 0, 0, "w_noBtagSF"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200", 0, 0, "w_noBtagSF"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>150", 0, 0, "w_noBtagSF"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep, 90$<$mbb$<$150", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150", 0, 0, "w_noBtagSF"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep, 90$<$mbb$<$150, 2 good b tags", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2", 0, 0, "w_noBtagSF"*yearWeight), 
//	}, sample_list_2016, false);
//  Table & cutflow_SR_3jet_mT1502017 = pm.Push<Table>("cutflow_SR_3jet_mT1502017", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut3, 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut3&&"pfmet>125", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>150", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep, 90$<$mbb$<$150", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep, 90$<$mbb$<$150, 2 good b tags", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2", 0, 0, "weight"*yearWeight), 
//	}, sample_list_2017, false);
//  Table & cutflow_SR_3jet_mT1502018 = pm.Push<Table>("cutflow_SR_3jet_mT1502018", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut3, 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut3&&"pfmet>125", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>150", 0, 0, "weight"*yearWeight),
...
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep, 90$<$mbb$<$150, 2 good b tags", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2", 0, 0, "weight"*yearWeight), 
//	}, sample_list_2018, false);
//  Table & cutflow_SR_3jet_mT150all = pm.Push<Table>("cutflow_SR_3jet_mT150all", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut3, 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut3&&"pfmet>125", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 150$<$mt MET lep", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>150", 0, 0, "weight"*yearWeight),
...
//	}, sample_list_comb, false);
//
//  // 4. 3 good jets, 150 > mT > 50
//  Table & cutflow_SR_3jet_50mT150_2016 = pm.Push<Table>("cutflow_SR_3jet_50mT150_2016", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut3, 0, 0, "w_noBtagSF"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut3&&"pfmet>125", 0, 0, "w_noBtagSF"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200", 0, 0, "w_noBtagSF"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150", 0, 0, "w_noBtagSF"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150, 90$<$mbb$<$150", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150&&mbb>90&&mbb<150", 0, 0, "w_noBtagSF"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150, 90$<$mbb$<$150, 2 good b tags", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150&&mbb>90&&mbb<150&&ngoodbtags==2", 0, 0, "w_noBtagSF"*yearWeight), 
//	}, sample_list_2016, false);
//  Table & cutflow_SR_3jet_50mT150_2017 = pm.Push<Table>("cutflow_SR_3jet_50mT150_2017", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut3, 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut3&&"pfmet>125", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150, 90$<$mbb$<$150", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150&&mbb>90&&mbb<150", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150, 90$<$mbb$<$150, 2 good b tags", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150&&mbb>90&&mbb<150&&ngoodbtags==2", 0, 0, "weight"*yearWeight), 
//	}, sample_list_2017, false);
//  Table & cutflow_SR_3jet_50mT150_2018 = pm.Push<Table>("cutflow_SR_3jet_50mT150_2018", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut3, 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut3&&"pfmet>125", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150", 0, 0, "weight"*yearWeight),
...
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150, 90$<$mbb$<$150, 2 good b tags", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150&&mbb>90&&mbb<150&&ngoodbtags==2", 0, 0, "weight"*yearWeight), 
//	}, sample_list_2018, false);
//  Table & cutflow_SR_3jet_50mT150_all = pm.Push<Table>("cutflow_SR_3jet_50mT150_all", vector<TableRow>{
//      TableRow("", WHLeptons==1&&basic_cut3, 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET", WHLeptons==1&&basic_cut3&&"pfmet>125", 0, 0, "weight"*yearWeight),
//	TableRow("125$<$MET, 200$<$mct", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200", 0, 0, "weight"*yearWeight), 
//	TableRow("125$<$MET, 200$<$mct, 50$<$mt MET lep$<$150", WHLeptons==1&&basic_cut3&&"pfmet>125&&mct>200&&mt_met_lep>90&&mt_met_lep<150", 0, 0, "weight"*yearWeight),
