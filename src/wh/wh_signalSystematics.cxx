...
*/
  ...
  PlotMaker * pmcomb = new PlotMaker();
    ...
    Table & signalRegion_125to200_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_125to200_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("FatJet genPt",  WHLeptons==1.&&genPt_ak8_higgsTagger==0.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&pfmet>125&&pfmet<200&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2&&hasNano",0,0,"weight*trig_eff"*yearWeight)
    ...
    Table & signalRegion_125to300_boosted_cutflow_comb = pmcomb->Push<Table>("signalRegion_125to300_boosted_cutflow_comb", vector<TableRow>{
      ...
      TableRow("FatJet genPt",  WHLeptons==1.&&genPt_ak8_higgsTagger==1.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&pfmet>125&&pfmet<300&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2&&hasNano",0,0,"weight*trig_eff"*yearWeight)
    ...
    Table & signalRegion_200to300_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_200to300_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("FatJet genPt",  WHLeptons==1.&&genPt_ak8_higgsTagger==0.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&pfmet>200&&pfmet<300&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2&&hasNano",0,0,"weight*trig_eff"*yearWeight)
    ...
    Table & signalRegion_300plus_boosted_cutflow_comb = pmcomb->Push<Table>("signalRegion_300plus_boosted_cutflow_comb", vector<TableRow>{
      ...
      TableRow("FatJet genPt",  WHLeptons==1.&&genPt_ak8_higgsTagger==1.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&pfmet>300&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2&&hasNano",0,0,"weight*trig_eff"*yearWeight)
    ...
    Table & signalRegion_300to400_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_300to400_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("FatJet genPt",  WHLeptons==1.&&genPt_ak8_higgsTagger==0.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&pfmet>300&&pfmet<400&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2&&hasNano",0,0,"weight*trig_eff"*yearWeight)
    ...
    Table & signalRegion_400plus_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_400plus_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("FatJet genPt",  WHLeptons==1.&&genPt_ak8_higgsTagger==0.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&pfmet>400&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2&&hasNano",0,0,"weight*trig_eff"*yearWeight)
    ...
    Table & signalRegion_3jet_125to200_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_3jet_125to200_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("FatJet genPt",  WHLeptons==1.&&LeadingNonBJetPt_med<300.&&genPt_ak8_higgsTagger==0.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&pfmet>125&&pfmet<200&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2&&hasNano",0,0,"weight*trig_eff"*yearWeight)
    ...
    Table & signalRegion_3jet_125to300_boosted_cutflow_comb = pmcomb->Push<Table>("signalRegion_3jet_125to300_boosted_cutflow_comb", vector<TableRow>{
      ...
      TableRow("FatJet genPt",  WHLeptons==1.&&LeadingNonBJetPt_med<300.&&genPt_ak8_higgsTagger==1.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&pfmet>125&&pfmet<300&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2&&hasNano",0,0,"weight*trig_eff"*yearWeight)
    ...
    Table & signalRegion_3jet_200to300_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_3jet_200to300_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("FatJet genPt",  WHLeptons==1.&&LeadingNonBJetPt_med<300.&&genPt_ak8_higgsTagger==0.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&pfmet>200&&pfmet<300&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2&&hasNano",0,0,"weight*trig_eff"*yearWeight)
    ...
    Table & signalRegion_3jet_300plus_boosted_cutflow_comb = pmcomb->Push<Table>("signalRegion_3jet_300plus_boosted_cutflow_comb", vector<TableRow>{
      ...
      TableRow("FatJet genPt",  WHLeptons==1.&&LeadingNonBJetPt_med<300.&&genPt_ak8_higgsTagger==1.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&pfmet>300&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2&&hasNano",0,0,"weight*trig_eff"*yearWeight)
    ...
    Table & signalRegion_3jet_300to400_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_3jet_300to400_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("FatJet genPt",  WHLeptons==1.&&LeadingNonBJetPt_med<300.&&genPt_ak8_higgsTagger==0.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&pfmet>300&&pfmet<400&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2&&hasNano",0,0,"weight*trig_eff"*yearWeight)
    ...
    Table & signalRegion_3jet_400plus_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_3jet_400plus_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("FatJet genPt",  WHLeptons==1.&&LeadingNonBJetPt_med<300.&&genPt_ak8_higgsTagger==0.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&pfmet>400&&mct>200&&mt_met_lep>150&&mbb>90&&mbb<150&&ngoodbtags==2&&hasNano",0,0,"weight*trig_eff"*yearWeight)
