...
int main(){
  ...
  auto signal_comb_600_300 = Process::MakeShared<Baby_full>("TChi WH (600,300)", Process::Type::signal, colors("t1tttt"),{signal_dir+"slim_*.root"},"pass&&mass_stop==600&&mass_lsp==300");
  auto signal_comb_800_1 = Process::MakeShared<Baby_full>("TChi WH (800,1)", Process::Type::signal, colors("t1tttt"),{signal_dir+"slim_*.root"},"pass&&mass_stop==800&&mass_lsp==1");
  
  vector<shared_ptr<Process> > short_sample_list_comb = {signal_comb_800_1,signal_comb_600_300};
  ...
  PlotMaker * pmcomb = new PlotMaker();
    ...
    Table & signalRegion_125to200_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_125to200_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("JER",           WHLeptons==1.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&pfmet>125&&pfmet<200&&jerup_mct>200&&mt_met_lep>150&&jerup_mbb>90&&jerup_mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
      ...
      TableRow("FastSim Corr",  WHLeptons==1.&&fastsim_MET>125&&fastsim_MET<200&&fastsim_MT>150&&fastsim_MCT>200&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&mbb>90&&mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
    ...
    Table & signalRegion_125to300_boosted_cutflow_comb = pmcomb->Push<Table>("signalRegion_125to300_boosted_cutflow_comb", vector<TableRow>{
      ...
      TableRow("JER",           WHLeptons==1.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&pfmet>125&&pfmet<300&&jerup_mct>200&&mt_met_lep>150&&jerup_mbb>90&&jerup_mbb<150&&ngoodbtags==2&&nHiggs==1&&hasNano",0,0,"weight*trig_eff"*yearWeight),
      ...
      TableRow("FastSim Corr",  WHLeptons==1.&&fastsim_MET>125&&fastsim_MET<300&&fastsim_MT>150&&fastsim_MCT>200&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&mbb>90&&mbb<150&&ngoodbtags==2&&nHiggs==1&&hasNano",0,0,"weight*trig_eff"*yearWeight),
    ...
    Table & signalRegion_200to300_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_200to300_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("JER",           WHLeptons==1.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&pfmet>200&&pfmet<300&&jerup_mct>200&&mt_met_lep>150&&jerup_mbb>90&&jerup_mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
      ...
      TableRow("FastSim Corr",  WHLeptons==1.&&fastsim_MET>200&&fastsim_MET<300&&fastsim_MT>150&&fastsim_MCT>200&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&mbb>90&&mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
    ...
    Table & signalRegion_300plus_boosted_cutflow_comb = pmcomb->Push<Table>("signalRegion_300plus_boosted_cutflow_comb", vector<TableRow>{
      ...
      TableRow("JER",           WHLeptons==1.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&pfmet>300&&jerup_mct>200&&mt_met_lep>150&&jerup_mbb>90&&jerup_mbb<150&&ngoodbtags==2&&nHiggs==1&&hasNano",0,0,"weight*trig_eff"*yearWeight),
      ...
      TableRow("FastSim Corr",  WHLeptons==1.&&fastsim_MET>300&&fastsim_MT>150&&fastsim_MCT>200&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&mbb>90&&mbb<150&&ngoodbtags==2&&nHiggs==1&&hasNano",0,0,"weight*trig_eff"*yearWeight),
    ...
    Table & signalRegion_300to400_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_300to400_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("JER",           WHLeptons==1.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&pfmet>300&&pfmet<400&&jerup_mct>200&&mt_met_lep>150&&jerup_mbb>90&&jerup_mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
      ...
      TableRow("FastSim Corr",  WHLeptons==1.&&fastsim_MET>300&&fastsim_MET<400&&fastsim_MT>150&&fastsim_MCT>200&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&mbb>90&&mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
    ...
    Table & signalRegion_400plus_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_400plus_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("JER",           WHLeptons==1.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&pfmet>400&&jerup_mct>200&&mt_met_lep>150&&jerup_mbb>90&&jerup_mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
      ...
      TableRow("FastSim Corr",  WHLeptons==1.&&fastsim_MET>400&&fastsim_MT>150&&fastsim_MCT>200&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==2&&mbb>90&&mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
    ...
    Table & signalRegion_3jet_125to200_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_3jet_125to200_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("JER",           WHLeptons==1.&&LeadingNonBJetPt_med<300.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&pfmet>125&&pfmet<200&&jerup_mct>200&&mt_met_lep>150&&jerup_mbb>90&&jerup_mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
      ...
      TableRow("FastSim Corr",  WHLeptons==1.&&LeadingNonBJetPt_med<300.&&fastsim_MET>125&&fastsim_MET<200&&fastsim_MT>150&&fastsim_MCT>200&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&mbb>90&&mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
    ...
    Table & signalRegion_3jet_125to300_boosted_cutflow_comb = pmcomb->Push<Table>("signalRegion_3jet_125to300_boosted_cutflow_comb", vector<TableRow>{
      ...
      TableRow("JER",           WHLeptons==1.&&LeadingNonBJetPt_med<300.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&pfmet>125&&pfmet<300&&jerup_mct>200&&mt_met_lep>150&&jerup_mbb>90&&jerup_mbb<150&&ngoodbtags==2&&nHiggs==1&&hasNano",0,0,"weight*trig_eff"*yearWeight),
      ...
      TableRow("FastSim Corr",  WHLeptons==1.&&LeadingNonBJetPt_med<300.&&fastsim_MET>125&&fastsim_MET<300&&fastsim_MT>150&&fastsim_MCT>200&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&mbb>90&&mbb<150&&ngoodbtags==2&&nHiggs==1&&hasNano",0,0,"weight*trig_eff"*yearWeight),
    ...
    Table & signalRegion_3jet_200to300_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_3jet_200to300_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("JER",           WHLeptons==1.&&LeadingNonBJetPt_med<300.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&pfmet>200&&pfmet<300&&jerup_mct>200&&mt_met_lep>150&&jerup_mbb>90&&jerup_mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
      ...
      TableRow("FastSim Corr",  WHLeptons==1.&&LeadingNonBJetPt_med<300.&&fastsim_MET>200&&fastsim_MET<300&&fastsim_MT>150&&fastsim_MCT>200&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&mbb>90&&mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
    ...
    Table & signalRegion_3jet_300plus_boosted_cutflow_comb = pmcomb->Push<Table>("signalRegion_3jet_300plus_boosted_cutflow_comb", vector<TableRow>{
      ...
      TableRow("JER",           WHLeptons==1.&&LeadingNonBJetPt_med<300.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&pfmet>300&&jerup_mct>200&&mt_met_lep>150&&jerup_mbb>90&&jerup_mbb<150&&ngoodbtags==2&&nHiggs==1&&hasNano",0,0,"weight*trig_eff"*yearWeight),
      ...
      TableRow("FastSim Corr",  WHLeptons==1.&&LeadingNonBJetPt_med<300.&&fastsim_MET>300&&fastsim_MT>150&&fastsim_MCT>200&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&mbb>90&&mbb<150&&ngoodbtags==2&&nHiggs==1&&hasNano",0,0,"weight*trig_eff"*yearWeight),
    ...
    Table & signalRegion_3jet_300to400_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_3jet_300to400_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("JER",           WHLeptons==1.&&LeadingNonBJetPt_med<300.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&pfmet>300&&pfmet<400&&jerup_mct>200&&mt_met_lep>150&&jerup_mbb>90&&jerup_mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
      ...
      TableRow("FastSim Corr",  WHLeptons==1.&&LeadingNonBJetPt_med<300.&&fastsim_MET>300&&fastsim_MET<400&&fastsim_MT>150&&fastsim_MCT>200&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&mbb>90&&mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
    ...
    Table & signalRegion_3jet_400plus_resolved_cutflow_comb = pmcomb->Push<Table>("signalRegion_3jet_400plus_resolved_cutflow_comb", vector<TableRow>{
      ...
      TableRow("JER",           WHLeptons==1.&&LeadingNonBJetPt_med<300.&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&pfmet>400&&jerup_mct>200&&mt_met_lep>150&&jerup_mbb>90&&jup_mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
      ...
      TableRow("FastSim Corr",  WHLeptons==1.&&LeadingNonBJetPt_med<300.&&fastsim_MET>400&&fastsim_MT>150&&fastsim_MCT>200&&"pass&&nvetoleps==1&&PassTrackVeto&&PassTauVeto&&ngoodjets==3&&mbb>90&&mbb<150&&ngoodbtags==2&&nHiggs==0&&hasNano",0,0,"weight*trig_eff"*yearWeight),
...
if(single_thread) pmcomb->multithreaded_ = false;
  ...
  for(int iProc = 0; iProc < nSignals; iProc++){
    for(unsigned iTable(0); iTable < 12; iTable++){
      ...
      for(unsigned iVar(0); iVar < 21; iVar++){
