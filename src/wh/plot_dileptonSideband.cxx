...
int main(){
  ...
  //Selections
  NamedFunc dilepton_basic2jet       = WHLeptons>=1&&"pass&&nvetoleps==2&&ngoodjets==2&&pfmet>125&&mt_met_lep>100&&ngoodbtags==2";
  NamedFunc dilepton_basic3jet       = WHLeptons>=1&&LeadingNonBJetPt_med<300&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>125&&mt_met_lep>100&&ngoodbtags==2";

  NamedFunc dilepton_basic2jet_mbb       = WHLeptons>=1&&"pass&&nvetoleps==2&&ngoodjets==2&&pfmet>125&&(mbb<90||mbb>150)&&mt_met_lep>100&&ngoodbtags==2";
  NamedFunc dilepton_basic3jet_mbb       = WHLeptons>=1&&LeadingNonBJetPt_med<300&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>125&&(mbb<90||mbb>150)&&mt_met_lep>100&&ngoodbtags==2";
  ...
  NamedFunc dilepton_looseLep_lowMT_MbbSide = WHLeptons>=1&&"pass&&nvetoleps==2&&ngoodjets==2&&pfmet>125&&(mbb<90||mbb>150)&&mct>200&&mt_met_lep>100&&ngoodbtags==2";
  ...
  NamedFunc dilepton_looseLep_loose3jet_lowMT_MbbSide = WHLeptons>=1&&LeadingNonBJetPt_med<300&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>125&&(mbb<90||mbb>150)&&mct>200&&mt_met_lep>100&&ngoodbtags==2";
  NamedFunc dilepton_looseLep_loose3jet_lowMT_highMET_MbbSide = WHLeptons>=1&&LeadingNonBJetPt_med<300&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>300&&(mbb<90||mbb>150)&&mct>200&&mt_met_lep>100&&ngoodbtags==2";
  NamedFunc dilepton_looseLep_loose3jet_lowMT_lowMCT_MbbSide = WHLeptons>=1&&LeadingNonBJetPt_med<300&&"pass&&nvetoleps==2&&ngoodjets==3&&pfmet>125&&(mbb<90||mbb>150)&&mct>150&&mt_met_lep>100&&ngoodbtags==2";
  ...
  vector<NamedFunc> sels   = {dilepton_basic2jet,
                              dilepton_basic3jet,
                              dilepton_basic2jet_mbb,
                              dilepton_basic3jet_mbb,
                              ...
                              dilepton_looseLep_loose3jet_lowMT_lowMCT_MbbSide,
  ...
  vector<string> sels_tags = {"_dilepton_basic2jet",
                              "_dilepton_basic3jet",
                              "_dilepton_basic2jet_mbb",
                              "_dilepton_basic3jet_mbb",
  ...
  vector<PlotMaker *> pms = {/*pm2016_signal,pm2017_signal,*/pm2018_signal/*,pmComb_signal*/};
  vector<vector<shared_ptr<Process> > > samples_Run2 = {/*sample_list_signal_2016,sample_list_signal_2017,*/sample_list_signal_2018/*,sample_list_signal_Comb*/};
  vector<string> years = {/*"y2016_signal","y2017_signal",*/"y2018_signal"/*,"yAll_signal"*/};
  ...
  for(uint isel=0;isel<sels.size();isel++){
    for(uint iyear=0;iyear<samples_Run2.size();iyear++){
      for(uint iweight=0;iweight<weights.size();iweight++){
          ...
          pms[iyear]->Push<Hist1D>(Axis(10, 0, 100., "vetoleps_pt[0]", "vetoleps_pt[0] [GeV]"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("coarse_"+years[iyear]+sels_tags[isel]);
          
          pms[iyear]->Push<Hist1D>(Axis(10, 0, 100., "vetoleps_pt[1]", "vetoleps_pt[1] [GeV]"),
            sels[isel], samples_Run2[iyear], all_plot_types).Weight(weights[iweight]).Tag("coarse_"+years[iyear]+sels_tags[isel]);
