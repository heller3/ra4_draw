...
Float_t w_noBtagSF;
Int_t njets;
std::vector<float> ak4pfjets_CSV;
std::vector<float> ak4pfjets_deepCSV;
std::vector<float> ak4pfjets_pt;
std::vector<float> ak4pfjets_eta;
std::vector<float> ak4pfjets_phi;
std::vector<float> dphi_ak4pfjet_met;
std::vector<float> ak4pfjets_m;
std::vector<int> ak4pfjets_hadron_flavor;
Int_t lep1_pdgid;
Int_t lep2_pdgid;
Float_t lep1_relIso;
Float_t lep2_relIso;
...
std::vector<int> gen_gmotherid;
std::vector<int> gen_gmotheridx;

### isolated tracks ###
std::vector<int> isoTracks_charge;
#std::vector<double> isoTracks_absIso;
#std::vector<double> isoTracks_dz;
std::vector<int> isoTracks_pdgId;
#std::vector<bool> isoTracks_isVetoTrack;
#std::vector<bool> isoTracks_isVetoTrack_v2;
#std::vector<bool> isoTracks_isVetoTrack_v3;


### taus ###

#std::vector<double> tau_passID;
Int_t ngoodtaus;
#std::vector<double> tau_againstMuonTight;
#std::vector<double> tau_againstElectronLoose;
#std::vector<bool> tau_isVetoTau;
#std::vector<bool> tau_isVetoTau_v2;
...
std::vector<float> mus_id;
   ...
   Int_t           genPart_grandmotherId[200];   //[ngenPart]
   ...
   virtual bool     hasHiggs(Double_t weight, Long64_t jentry);
   virtual void     hasW(Double_t weight, Long64_t jentry );
   virtual void     genAnalysis(Double_t weight, Long64_t jentry );
   virtual void     bgLoop();
   virtual void     sigLoop();
   virtual void     findMassWindow();
...
void evtLooper::Init(TTree *tree)
{
   ...
   htH = new TH1F("ht", "ht", 30,150,2000);
   met_ptH = new TH1F("met_pt", "met_pt", 30, 150, 1500);
   mt2H = new TH1F("mt2", "mt2", 30, 150, 1000);
   nJet30H = new TH1F("nJet30", "nJet30", 9, 1, 10);
   

   HlowCSV = new TH1F("HlowCSV", "HlowCSV", 50,0,1.5);
   HJet_pt = new TH1F("HJet_pt", "HJet_pt", 50,0,1000);
   HJet_mass = new TH1F("HJet_mass", "HJet_mass",50, 0, 400);
   H_mass = new TH1F("H_mass", "H_mass",50, 0, 400);
   H_mass_dRbb = new TH1F("H_mass_dRbb", "H_mass_dRbb",50, 0, 400);
   H_pt = new TH1F("H_pt", "H_pt", 50,0,1000);
   H_dRbb_pt = new TH2F("H_dRbb_pt", "", 50, 0, 8, 50, 0, 1200);

   WJet_pt = new TH1F("Jet_pt", "Jet_pt", 50,150,1000);
   WJet_mass = new TH1F("WJet_mass", "WJet_mass",50, 0, 400);
   W_mass = new TH1F("W_mass", "W_mass", 50, 0, 400);
   W_mass_dRbb = new TH1F("W_mass_dRbb", "W_mass_dRbb", 50, 0, 400);
   W_pt = new TH1F("W_pt", "W_pt", 50,0,1000);
   W_dRbb_pt = new TH2F("W_dRbb_pt", "", 50, 0, 8, 50, 0, 1200);

   genbJet_pt = new TH1F("genbJet_pt", "genbJet_pt", 50,150,1000);
   genHJet_pt = new TH1F("genHJet_pt", "genHJet_pt", 50,150,1000);
   genH_mass = new TH1F("genH_mass", "genH_mass", 50, 0, 400);
   genH_pt = new TH1F("genH_pt", "genH_pt", 50,0,1000);
   genH_dRbb_pt = new TH2F("genH_dRbb_pt", "", 50, 0, 4, 50, 0, 1200);

   genWJet_pt = new TH1F("genWJet_pt", "genWJet_pt", 50,150,1000);
   genW_mass = new TH1F("genWJet_mass", "genW_mass", 50, 0, 400);
   genW_pt = new TH1F("genW_pt", "genW_pt", 50, 0,1000);
   genW_dRbb_pt = new TH2F("genW_dRbb_pt", "", 50, 0, 8, 50, 0, 1200);

   mt2_23j1b_high = new TH1F("mt2_23j1b_high", "", 100, 0, 1500);
   mt2_23j2b_high = new TH1F("mt2_23j2b_high", "", 100, 0, 1500);
   mt2_46j1b_high = new TH1F("mt2_46j1b_high", "", 100, 0, 1500);
   mt2_46j2b_high = new TH1F("mt2_46j2b_high", "", 100, 0, 1500);
   mt2_23j1b_med = new TH1F("mt2_23j1b_med", "", 100, 0, 1500);
   mt2_23j2b_med = new TH1F("mt2_23j2b_med", "", 100, 0, 1500);
   mt2_46j1b_med = new TH1F("mt2_46j1b_med", "", 100, 0, 1500);
   mt2_46j2b_med = new TH1F("mt2_46j2b_med", "", 100, 0, 1500);
   ...
   gen_nlow_HdR = 0;
   nJets_with_H_mass = 0;
   CSV_vs_mass = new TH2F("CSV_vs_mass", "", 50, 0, 1, 50, 0, 200);
